...
const ERROR_MESSAGES: Record<string, string> = {
  AccessDenied:
    "That Google account isn't authorized for CandidateRadar. Ask a teammate for an invite, or sign in with your work Google account.",
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-canvas">
      <div className="w-full max-w-[360px] card p-8 flex flex-col gap-6">
        <div className="flex flex-col gap-3">
          <span className="w-8 h-8 rounded-sm bg-ink text-white flex items-center justify-center">
            <Radar className="w-4 h-4" strokeWidth={2.5} />
          </span>
          <div>
            <h1 className="text-heading-md text-ink">Sign in to CandidateRadar</h1>
